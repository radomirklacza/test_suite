...
def projects_action(action, driver, url, piuser, fakeuser, testname, errordb, datadb, concurrent_users):
    ...
    load(driver, url, testname, errordb, datadb, search_for, 'xpath', 'institution_projects', concurrent_users)
